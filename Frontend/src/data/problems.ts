...
export const problems: Problem[] = [
  ...
  },
  {
    ...
    "industry": "IT",
    "problem_statement": "Tech Innovations Ltd is a leading global enterprise operating at the cutting edge of the IT sector, with a mission 'To revolutionize service delivery and create long-term stakeholder value through trusted innovation'. With an annual revenue exceeding $5.4 billion and a presence in over 30 countries, we collectively employ over 42,000 passionate professionals.\n\nThis job simulation is with our advanced innovation division, Tech Innovations Ltd Insights & Generative Technologies. You will gain insight into how our multi-disciplinary experts solve some of the most complex business problems using state-of-the-art AI solutions.\n\nAs a Agentic AI Consultant, you are tasked with delivering an innovative AI-driven solution capable of helping users navigate complex challenges efficiently. From understanding initial requirements to integrating advanced models and evaluating performance, your mission is to design a robust application that balances functionality, usability, and ethical considerations. Imagine working on a groundbreaking AI product for a global enterprise that aims to revolutionize productivity and technological capabilities. Your mission is to design, build, and test a specialized tool equipped with state-of-the-art functionality and a goal-oriented problem-solving approach. The solution should be able to seamlessly integrate into existing workflows, deliver high-quality outputs, and meet the specific needs of the business. You will also focus on responsible AI practices, ensuring that your deliverables meet strict ethical standards while offering a premium user experience.",
    "difficulty": "Intermediate",
    "solved": false,
    "tags": [
      "Python",
    ...
    "steps": [
      "**Task 1:** Understand the Role of Prompts: \n\n You have been hired by an enterprise that manages a large volume of customer service tickets. They want to use GenAI to classify tickets by issue type (e.g., billing, technical, feedback) and generate summaries for faster resolution.\n\n### What you'll learn\nResearch prompt engineering fundamentals. Learn how prompt structures (context, constraints, and examples) influence GenAI outputs. Study enterprise-centric use cases, focusing on structured data generation. 8\n\n### What you'll do\nSubmit a **1-page report** summarizing: - Key principles of prompt engi- neering. - How structured prompts can benefit enterprise workflows. - Examples of prompt patterns for structured output.",
      "**Task 2:** Dataset Setup and Prompt Design: \n\n You\u2019ve been provided with a sample dataset containing customer service tickets with columns like \u2018Ticket ID\u2018, \u2018Issue Description\u2018, and \u2018Customer Priority\u2018. Your goal is to design initial prompts to classify these tickets by issue type and summarize them.\n\n### What you'll learn\n- Analyze the provided dataset structure. - Design 3 initial prompts: 1. Classify tickets into predefined categories. 2. Generate concise summaries of ticket issues. 3. Identify high-priority customer concerns.\n\n### What you'll do\nSubmit a **document with your 3 prompts**, their intended outputs, and reasoning for their desig.",
      "**Task 3:** Build and Execute Prompts: \n\n Run your initial prompts on a GenAI platform (e.g., OpenAI GPT-4) and analyze the outputs. Refine your prompts iteratively to improve classification accuracy and summary quality.\n\n### What you'll learn\n- Test your prompts using the sample customer ticket dataset. - Adjust context, constraints, or examples to improve outputs. - Document the iterative refinements made to each prompt.\n\n### What you'll do\nSubmit: 1. **Initial outputs** from GenAI. 2. **Refined prompts** and their improved outputs. 3. A **brief explanation** of changes made and their impac.",
      "**Task 4:** Analyze Hallucinations and Explain GenAI Behavior: \n\n Some GenAI outputs con- tain errors (e.g., misclassifications, irrelevant summaries). Your task is to identify and explain these hallucinations, then adjust your prompts to minimize such errors.\n\n### What you'll learn\n- Analyze common hallucinations in the outputs (e.g., incorrect ticket classifications). - Adjust prompts to reduce errors (e.g., add constraints or improve examples). - Explain the behavior behind the hallucinations (e.g., ambiguous wording, lack of context).\n\n### What you'll do\nSubmit a **hallucination analysis report** with: - Examples of errors. - Adjusted prompts to reduce hallucinations. - Explanations of GenAI behavior causing error.",
      "**Task 5:** Audit for Responsible AI: \n\n Ensure your prompts and outputs adhere to Responsible AI principles, including fairness, transparency, and accuracy. Avoid biases in ticket classifications and summaries.\n\n### What you'll learn\n- Perform a bias audit on GenAI outputs (e.g., verify fair classifi- cation across all categories). - Document steps taken to ensure transparency and accuracy in prompts. - Suggest improvements to align with Responsible AI principles.\n\n### What you'll do\nSubmit a **Responsible AI checklist** covering: - Bias detection results. - Transparency steps taken. - Suggestions for ethical improvement.",
      "**Task 6:** Present Your Final Prompt Engineering Playbook: \n\n Compile your refined prompts, evaluation metrics, and Responsible AI findings into a **Prompt Engineering Playbook**. This will serve as a reusable resource for the enterprise.\n\n### What you'll learn\n- Summarize your prompt design process and key insights. - Include examples of refined prompts and outputs. - Provide actionable strategies for minimizing hallucinations and ensuring Responsible AI compliance.\n\n### What you'll do\nSubmit your **Prompt Engineering Playbook** (5-10 pages) with: - Overview of prompt design principles. - Tested and refined prompts. - Evaluation metrics and Responsible AI strategies."
],
    "knowledgeTest": [],
    "submissionInstructions": [
      "Task 1: Submit a **1-page report** summarizing: - Key principles of prompt engi- neering. - How structured p...",
  ...
  },
  {
    ...
    "industry": "GenAI",
    "problem_statement": "Tech Innovations Ltd is a leading global enterprise operating at the cutting edge of the GenAI sector, with a mission 'To revolutionize service delivery and create long-term stakeholder value through trusted innovation'. With an annual revenue exceeding $5.4 billion and a presence in over 30 countries, we collectively employ over 42,000 passionate professionals.\n\nThis job simulation is with our advanced innovation division, Tech Innovations Ltd Insights & Generative Technologies. You will gain insight into how our multi-disciplinary experts solve some of the most complex business problems using state-of-the-art AI solutions.\n\nAs a LangChain Developer, you are tasked with delivering an innovative AI-driven solution capable of helping users navigate complex challenges efficiently. From understanding initial requirements to integrating advanced models and evaluating performance, your mission is to design a robust application that balances functionality, usability, and ethical considerations. Imagine working on a groundbreaking AI product for a global enterprise that aims to revolutionize productivity and technological capabilities. Your mission is to design, build, and test a specialized tool equipped with state-of-the-art functionality and a goal-oriented problem-solving approach. The solution should be able to seamlessly integrate into existing workflows, deliver high-quality outputs, and meet the specific needs of the business. You will also focus on responsible AI practices, ensuring that your deliverables meet strict ethical standards while offering a premium user experience.",
    "difficulty": "Intermediate",
    "solved": false,
    "tags": [
      "Python",
